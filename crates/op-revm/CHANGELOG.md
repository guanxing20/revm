...
## [13.0.0](https://github.com/guanxing20/revm/compare/op-revm-v12.0.0...op-revm-v13.0.0) - 2025-11-10
...
- *(jovian)* add da footprint block limit. ([#3003](https://github.com/guanxing20/revm/pull/3003))
- *(op-revm)* implement jovian operator fee fix ([#2996](https://github.com/guanxing20/revm/pull/2996))
...
- add fallible conversion from OpHaltReason to HaltReason ([#2649](https://github.com/guanxing20/revm/pull/2649))
...
- add precompiles getter to OpPrecompiles ([#2444](https://github.com/guanxing20/revm/pull/2444))
...
- *(jovian)* fixes the DA footprint update storage slot. fix l1 fork associated with Jovian. ([#3120](https://github.com/guanxing20/revm/pull/3120))
- *(op-revm)* add missing enveloped_tx validation in validate_env ([#3094](https://github.com/guanxing20/revm/pull/3094))
- *(op-revm)* return error instead of panic when enveloped_tx is missing ([#3055](https://github.com/guanxing20/revm/pull/3055))
- add missing is_fee_charge_disabled check ([#3007](https://github.com/guanxing20/revm/pull/3007))
- Apply spelling corrections from PRs #2926, #2915, #2908 ([#2978](https://github.com/guanxing20/revm/pull/2978))
- *(op-revm)* clear enveloped_tx for deposit txs in build_fill and align docs ([#2957](https://github.com/guanxing20/revm/pull/2957))
- *(handler)* correct transaction ID decrement logic ([#2892](https://github.com/guanxing20/revm/pull/2892))
- *(op-revm)* system tx not enveloped ([#2807](https://github.com/guanxing20/revm/pull/2807))
...
- *(op)* call cleanup on local context ([#2499](https://github.com/guanxing20/revm/pull/2499))
- *(op)* mark caller account as touched ([#2495](https://github.com/guanxing20/revm/pull/2495))
...
- *(op)* backport of #3073 fix for l1block info ([#3076](https://github.com/guanxing20/revm/pull/3076))
- backport v89 changelog ([#3075](https://github.com/guanxing20/revm/pull/3075))
- *(op)* split paths for deposit tx in caller deduction ([#3041](https://github.com/guanxing20/revm/pull/3041))
...
- Set l2_block in try_fetch for pre-Isthmus forks; add reload tests ([#2994](https://github.com/guanxing20/revm/pull/2994))
- prealloc few frames ([#2965](https://github.com/guanxing20/revm/pull/2965))
- treat empty input as zero operator fee in operator_fee_charge ([#2973](https://github.com/guanxing20/revm/pull/2973))
- add SECURITY.md ([#2956](https://github.com/guanxing20/revm/pull/2956))
- *(op-revm)* rm redundant phantom ([#2943](https://github.com/guanxing20/revm/pull/2943))
- *(op-revm)* add serialize DepositTransactionParts test ([#2942](https://github.com/guanxing20/revm/pull/2942))
...
- *(op-revm)* Adds caller nonce assertion to op-revm intergation tests ([#2815](https://github.com/guanxing20/revm/pull/2815))
- *(op-revm)* Full test coverage `OpTransactionError` ([#2818](https://github.com/guanxing20/revm/pull/2818))
- Update test data for renamed tests ([#2817](https://github.com/guanxing20/revm/pull/2817))
...
- *(op-revm)* test for optional balance check ([#2746](https://github.com/guanxing20/revm/pull/2746))
...
- *(op/handler)* verify caller account is touched by zero value transfer ([#2669](https://github.com/guanxing20/revm/pull/2669))
- use TxEnv::builder ([#2652](https://github.com/guanxing20/revm/pull/2652))
- release ([#2657](https://github.com/guanxing20/revm/pull/2657))
- bump v77 ([#2651](https://github.com/guanxing20/revm/pull/2651))
...
- *(op-revm)* impl type alias for Default OpEvm ([#2576](https://github.com/guanxing20/revm/pull/2576))
...
- *(test)* preserve order of fields in json fixtures ([#2541](https://github.com/guanxing20/revm/pull/2541))
- op remove circular dep ([#2540](https://github.com/guanxing20/revm/pull/2540))
...
- release ([#2500](https://github.com/guanxing20/revm/pull/2500))
- *(op)* revert previous and localize fix ([#2504](https://github.com/guanxing20/revm/pull/2504))
- *(op-revm)* release v4.0.1 ([#2497](https://github.com/guanxing20/revm/pull/2497))
- *(op)* Add test coverage to OP result module ([#2491](https://github.com/guanxing20/revm/pull/2491))
- *(op)* Add test coverage to `OpTransactionError` ([#2490](https://github.com/guanxing20/revm/pull/2490))
...
- *(op)* Set l2 block num in reloaded isthmus l1 block info ([#2465](https://github.com/guanxing20/revm/pull/2465))
- Add clones to FrameData ([#2482](https://github.com/guanxing20/revm/pull/2482))
- *(op)* Add test for verifying default OpSpecId update ([#2478](https://github.com/guanxing20/revm/pull/2478))
